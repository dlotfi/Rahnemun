...
;(function(factory) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        // ##################################### ADDDED #######################################
        var LocalDate = options
            ? options.local_date || Date
            : Date;
        // ############ Replace all instances of "new Date(" with "new LocalDate(" ############
                        ...
                        $.each(enabled_dates, function() {
                            ...
                            if (rule[2][0] != '*')
                                ...
                                tmpDates.push(parseInt(
                                    ...
                                    (rule[0][0] == '*' ? (rule[1][0] == '*' ? '31' : new LocalDate(rule[2][0], rule[1][0], 0).getDate()) : str_pad(rule[0][0], 2)), 10));
            ...
            if (is_disabled(first_selectable_year, first_selectable_month, first_selectable_day)) {
                ...
                while (is_disabled(first_selectable_year, first_selectable_month)) {
                    ...
                    if (!start_date) {
                        ...
                        first_selectable_day = new LocalDate(first_selectable_year, first_selectable_month + 1, 0).getDate();
                ...
                while (is_disabled(first_selectable_year, first_selectable_month, first_selectable_day)) {
                    ...
                    // use the Date object to normalize the date
                    // for example, 2011 05 33 will be transformed to 2011 06 02
                    date = new LocalDate(first_selectable_year, first_selectable_month, first_selectable_day);
                ...
                if (undefined !== icon) {
                    ...
                    if (plugin.settings.inside)
                        ...
                        icon.css({
                            ...
                            // ##################################### CHANGED #######################################
                            'left': element_margin_left + icon_margin_right
                    ...
                    // position the icon accordingly
                        ...
                        icon.css({
                            'top': element_margin_top + ((element_height - icon_height) / 2),
                            // ##################################### CHANGED #######################################
                            'left': element_margin_left - icon_width - icon_margin_left
            ...
            if (!plugin.settings.always_visible) {
                ...
                if (plugin.settings.container.is('body')) {
                    ...
                    var
                        ...
                        // ##################################### CHANGED #######################################
                        left = (undefined !== icon ? icon.offset().left - datepicker_width : $element.offset().left - datepicker_width) - plugin.settings.offset[0],
                ...
                if (regexp.length) {
                    ...
                    if ((segments = regexp.exec(str_date))) {
                        ...
                        if (valid) {
                            ...
                            var date = new LocalDate(original_year, (original_month || 1) - 1, original_day || 1);
        ...
        var generate_daypicker = function() {
            ...
            var
                ...
                days_in_month = new LocalDate(selected_year, selected_month + 1, 0).getDate(),

                // get the selected month's starting day (from 0 to 6)
                first_day = new LocalDate(selected_year, selected_month, 1).getDay(),

                // how many days are there in the previous month
                days_in_previous_month = new LocalDate(selected_year, selected_month, 0).getDate(),
            ...
            for (i = 0; i < 42; i++) {
                ...
                if (i % 7 === 0 && plugin.settings.show_week_number)
                    ...
                    html += '<td class="dp_week_number">' + getWeekNumber(new LocalDate(selected_year, selected_month, (i - days_from_previous_month + 1))) + '</td>';
                ...
                if (plugin.settings.select_other_months && (i < days_from_previous_month || day > days_in_month)) {
                    ...
                    // use the Date object to normalize the date
                    // for example, 2011 05 33 will be transformed to 2011 06 02
                    var real_date = new LocalDate(selected_year, selected_month, day),
                    ...
                    if ($.inArray(year, rule[2]) > -1 || $.inArray('*', rule[2]) > -1)
                        ...
                        if ((typeof month != 'undefined' && $.inArray(month, rule[1]) > -1) || $.inArray('*', rule[1]) > -1)
                            ...
                            if ((typeof day != 'undefined' && $.inArray(day, rule[0]) > -1) || $.inArray('*', rule[0]) > -1) {
                                ...
                                // get the weekday
                                var weekday = new LocalDate(year, month - 1, day).getDay();
        ...
        var select_date = function(year, month, day, view, cell) {
            ...
            var
                ...
                default_date = new LocalDate(year, month, day, 12, 0, 0),
