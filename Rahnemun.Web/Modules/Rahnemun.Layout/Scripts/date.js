...
$(function () {
    $("input[data-dateculture]").each(function () {
        var culture = $(this).data("dateculture");
        var config = culture == "fa-ir" ? datepicker_fa_IR : null;
        $(this).Zebra_DatePicker(config);
    });
});
