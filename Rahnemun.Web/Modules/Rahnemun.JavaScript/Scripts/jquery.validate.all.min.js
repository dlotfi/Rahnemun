...
*/
$.validator.addMethod("dummy",function(){return!0},""),function(n){n.fn.isValid=function(){n(this).data("unobtrusiveValidation")||n.validator.unobtrusive.parse(this);var t=n(this).data("validator").settings;return t.showErrors=function(){var t=n(this.currentForm),i=t.data("invalstate1");!i&&this.numberOfInvalids()?(t.data("invalstate1",!0),t.trigger("valstatechange",!1)):i&&!this.numberOfInvalids()&&(t.data("invalstate1",!1),t.trigger("valstatechange",!0));this.defaultShowErrors()},n(this).valid()};n.fn.showErrors=function(t,i){var f=n(this).validate(),r,u;n(this).find("input, select, textarea").each(function(){n(this).rules("add","dummy")});r=n(this);u=r.data("invalstate2");u||n.isEmptyObject(t)?u&&n.isEmptyObject(t)&&(r.data("invalstate2",!1),r.trigger("valstatechange",!0)):(r.data("invalstate2",!0),r.trigger("valstatechange",!1));t&&t[""]&&(i&&i(t[""]),delete t[""]);f.showErrors(t);f.focusInvalid()}}(jQuery);